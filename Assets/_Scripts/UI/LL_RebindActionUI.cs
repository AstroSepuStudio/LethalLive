...
{
    [SerializeField] internal TabletManager tabletManager;
    ...
    //TextMeshProUGUI rebindPrompt
    //{
    //    get => tabletManager.RebindText;
    //    set => m_RebindText = tabletManager.RebindText;
    //}
    ...
    //GameObject rebindOverlay
    //{
    //    get => tabletManager.RebindOverlay;
    //    set => m_RebindOverlay = tabletManager.RebindOverlay;
    //}
    ...
    private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
    {
        ...
        m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
            .OnCancel(
                operation =>
                {
                    ...
                    if (tabletManager.RebindOverlay != null)
                        tabletManager.RebindOverlay.SetActive(false);
                    UpdateBindingDisplay();
                    CleanUp();
                })
            .OnComplete(
        ...
        tabletManager.RebindOverlay?.SetActive(true);
        if (tabletManager.RebindText != null)
        {
            var text = !string.IsNullOrEmpty(m_RebindOperation.expectedControlType)
                ? $"{partName}Waiting for {m_RebindOperation.expectedControlType} input..."
                : $"{partName}Waiting for input...";
            tabletManager.RebindText.text = text;
        }

        // If we have no rebind overlay and no callback but we have a binding text label,
        // temporarily set the binding text label to "<Waiting>".
        if (tabletManager.RebindOverlay == null && tabletManager.RebindText == null && m_RebindStartEvent == null && m_BindingText != null)
    ...
    protected void OnEnable()
    {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<LL_RebindActionUI>();
    ...
    private static List<LL_RebindActionUI> s_RebindActionUIs;
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<LL_RebindActionUI, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<LL_RebindActionUI, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}
