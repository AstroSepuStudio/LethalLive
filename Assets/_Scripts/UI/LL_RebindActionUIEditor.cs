...
[CustomEditor(typeof(LL_RebindActionUI))]
public class LL_RebindActionUIEditor : Editor
{
    protected void OnEnable()
    {
        ...
        m_TabletManagerProperty = serializedObject.FindProperty("tabletManager");
    ...
    public override void OnInspectorGUI()
    {
        ...
        using (new EditorGUI.IndentLevelScope())
        {
            ...
            EditorGUILayout.PropertyField(m_TabletManagerProperty);
        }
    ...
    private SerializedProperty m_TabletManagerProperty;
