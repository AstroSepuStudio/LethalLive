...
public class RoomDataEditor : Editor
{
    ...
    private const string BindingsSOPath = "Assets/_MapGeneration/Port Bindings SO.asset";
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_bindingsSO == null)
            _bindingsSO = AssetDatabase.LoadAssetAtPath<PortWallBindingsSO>(BindingsSOPath);
